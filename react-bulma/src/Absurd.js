    ...
    return (
      <div>
        <section id="colored-dna-back" className="hero is-white is-fullheight">
          ...
          is-4-fullhd is-offset-1-fullhd">
                  <figure className="image is-square">
                    <img src="../images/people-solving-a-puzzle.png" alt="people-solving-puzzle" />
                  </figure>
                </div>
        ...
        <section className="hero is-white is-fullheight">
          ...
          is-4-fullhd is-offset-1-fullhd">
                  <figure className="image is-square">
                    <img src="../images/undraw_Camera_re_cnp4.svg" alt="camera" />
                  </figure>
                </div>
        ...
        <section className="hero is-white is-fullheight">
          ...
          is-4-fullhd is-offset-1-fullhd" data-aos="fade-up">
                  <figure className="image is-square">
                    <img src="../images/undraw_Camera_re_cnp4.svg" alt="camera-2" />
                  </figure>
                </div>
